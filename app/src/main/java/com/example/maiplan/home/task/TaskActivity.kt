...
/**
 * This activity is responsible for managing and displaying Task screens.
 *
 * The activity sets up the UI content using Jetpack Compose and applies the app a theme.
 * Sets up the navigation between Task screens and with other screens on the Home component.
 */
